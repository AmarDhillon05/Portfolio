        ...
        <div className="flex items-center justify-center flex-col h-screen w-full">
            ...
            <div className="items-center justify-center flex flex-row">
                ...
                <a href="mailto:amardhillon844@gmail.com">
                    <Typed
                        text={`amardhillon844@gmail.com`}
                        className="text-4xl py-6 w-auto text-center m-auto hover:text-gray-200 transition-all duration-500"
                        delay={500}
                    />
                </a>
            </div>
            ...
            <div className="items-center justify-center flex flex-row">
                ...
                <a href="https://www.linkedin.com/in/amar-dhillon-917537261/">
                    <Typed
                        text={`https://www.linkedin.com/in/amar-dhillon-917537261/`}
                        className="text-4xl py-6 w-auto text-center m-auto hover:text-gray-200 transition-all duration-500"
                        delay={500}
                    />
                </a>
            ...
            <div className="items-center justify-center flex flex-row">
                ...
                <a href="https://github.com/AmarDhillon05">
                    <Typed
                        text={`https://github.com/AmarDhillon05`}
                        className="text-4xl py-6 w-auto text-center m-auto hover:text-gray-200 transition-all duration-500"
                        delay={500}
                    />
                </a>
            ...
            <div className="items-center justify-center flex flex-row">
                ...
                <a href="https://www.kaggle.com/amardhillon05">
                    <Typed
                        text={`https://www.kaggle.com/amardhillon05`}
                        className="text-4xl py-6 w-auto text-center m-auto hover:text-gray-200 transition-all duration-500"
                        delay={500}
                    />
                </a>
